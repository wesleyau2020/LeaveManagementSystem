                        ...
                        <?php if ($leaveDetail->year === $inputYear && $leaveDetail->leave_type_id === 1) : ?>
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?= $this->Form->postLink(__('Deactivate'), ['action' => 'deactivate', $user->id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to deactivate # {0}?', $user->id)]) ?>
                                </td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
